function calcShipping(sum, min, shipping) {
    ...
    if(productsSum == 0){shippingSum = 0;}// если productsSum равно 0,
    // то shippingSum присвоить значение 0

    if(productsSum >= freeShippingMinSum){shippingSum = 0;}   // если productsSum Больше или равна freeShippingMinSum,
    // то shippingSum присвоить значение 0

    if(productsSum > 0 && productsSum < freeShippingMinSum){shippingSum = shippingPrice;} // если productsSum больше 0 и меньше freeShippingMinSum,
